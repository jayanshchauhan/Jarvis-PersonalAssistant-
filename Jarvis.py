...
def sendEmail(to, content):
    ...
    server.login('jayanshchauhan2001@gmail.com', 'Jay12345678')
    server.sendmail('jayanshchauhan@gmail.com', to, content)
    server.close()


def screenshot():
    img = pyautogui.screenshot()
    img.save(r'D:\Users\dell\Desktop\screenshot.png')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # wb.open(query)
            ...
            video = 'C:\Mobile\oppo mobile\videos hd songs'
            audio = 'C:\Mobile\my music'
